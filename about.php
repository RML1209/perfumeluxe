...
<!-- Modal/Popup -->
    ...
    <div class="modal-content">
            ...
            <div class="swiper">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="1762076810_1760564665_perfume1.jpg" style="width:100%; height:400px; object-fit:cover;">
                    </div>
                    <div class="swiper-slide">
                        <img src="1763646924_1762069624_1760625282_perfume3.jpg" style="width:100%; height:400px; object-fit:cover;">
                    </div>
                    <div class="swiper-slide">
        ...
        <div class="product-info">
            <h2 style="margin-top:0; color:#e91e63;">Oud Imperial Luxe</h2>
...
<div id="discountPopup" style="display:none; position:fixed; bottom:20px; left:50%; transform:translateX(-50%); background:pink; color:darkgreen; padding:10px 20px; border-radius:50px; box-shadow:0 10px 30px rgba(233,30,99,0.4); z-index:99999; animation: bounce 2s infinite;"><a href="Comment.html">
    🎁 Now view <strong>" MY PROFILE"</strong> to get 10% offer!</a>
</div>
...
<!--<div style="margin:20px 0;">
    ...
    <small style="display:block; text-align:center; margin-top:5px;">Aisha from Dar es Salaam</small>
            ...
            <div class="action-buttons">
                ...
                <button class="btn btn-chat" onclick="window.open('https://wa.me/255XXXXXXXXX?text=Nauliza%20kuhusu%20Oud%20Imperial%20Luxe', '_blank')"><i class="fab fa-whatsapp">
                    </i>
                </button>
                    <button class="btn btn-order" onclick="window.open('https://wa.me/255XXXXXXXXX?text=Nimeona%20Oud%20Imperial%20Luxe%20nataka%20kuorder', '_blank')">
    ...
    <div class="comment-input-bar">
        <input type="text" class="comment-box" placeholder="Tuma maoni / Comment now..." />
