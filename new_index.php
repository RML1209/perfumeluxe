...
<body>
  ...
  <ul>
    ...
    <div class="user-icon"><a href="customer_dashboard.php" id="aboutBtn"><i class="fas fa-user" style="color:black;padding:10px;font-size:20px; background:linear-gradient(to right, #ff99cc, #ff66b2);border-radius:100px;"></i></a></div>
  </ul>
</nav>
  </header>
    ...
    <div class="product-card">
     ...
     <div class="header_profile_image">
      ...
      <p class="product-description">
        ...
        <b>Type:</b> <?php echo $row['scent_type']; ?><br>
        <b>Gender:</b> <?php echo $row['gender']; ?><br>
        <b>Price:</b> Tsh<?php echo $row['price']; ?>/=<br>
      </p>
...
<div class="dashboard-cards">
 <div class="card">
       <a href="login.php"><i class="fa-solid fa-right-to-bracket"></i><h3>LOGIN</h3></a>
        <p>Login now in your account to get our products.</p>
      </div>

 <div class="card">
       <a href="users_registration.php"><i class="fa-solid fa-user-plus"></i> <h3> REGISTER</h3></a>
